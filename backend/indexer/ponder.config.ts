...
export default createConfig({
  networks: {
    ...
    mumbai: { chainId: 80001, transport: http('https://fluent-sparkling-isle.matic-testnet.quiknode.pro/7b2d10e9a4fb16081c70736cf48bbc3deab89fdf/'), maxHistoricalTaskConcurrency: 10, maxRequestsPerSecond: 10 },
